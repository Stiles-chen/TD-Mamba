...
def get_parser():
    ...
    parser.add_argument(
        '--joint_Score',
        type=str,
        default='./work_dir/shrec17/14joint/epoch1_test_score.pkl')
    parser.add_argument(
        '--bone_Score',
        type=str,
        default='./work_dir/shrec17/14bone/epoch1_test_score.pkl')
    parser.add_argument(
        '--jointmotion_Score',
        type=str,
        default='./work_dir/shrec17/14motion/epoch1_test_score.pkl')
    parser.add_argument(
        '--bonemotion_Score',
        type=str,
        default='./work_dir/shrec17/14bone_motion/epoch1_test_score.pkl')
    parser.add_argument(
        '--val_sample',
        type=str,
        default='./ensemble/shrec17_14.txt')
    parser.add_argument(
        '--benchmark',
        type=str,
        default='Shrec_14')
