...
def get_parser():
    ...
    parser.add_argument(
        '--joint_Score',
        type=str,
        default='./work_dir/shrec17/28joint/epoch1_test_score.pkl')
    parser.add_argument(
        '--bone_Score',
        type=str,
        default='./work_dir/shrec17/28bone/epoch1_test_score.pkl')
    parser.add_argument(
        '--jointmotion_Score',
        type=str,
        default='./work_dir/shrec17/28motion/epoch1_test_score.pkl')
    parser.add_argument(
        '--val_sample',
        type=str,
        default='./ensemble/shrec17_28.txt')
    parser.add_argument(
        '--benchmark',
        type=str,
        default='Shrec_28')
